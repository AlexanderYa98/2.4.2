...
public class HibernateConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("web.model"); // указывается пакет в котором находятся сущности
        entityManagerFactory.setJpaVendorAdapter(new HibernateJpaVendorAdapter());// в качестве JPA адаптера будет использоваться хибер
